# 11. Kapitel. <br /><strong>In der Krieger-Heimat.</strong><br /><br /> {.unnumbered}
...
Kostbarkeiten ausplaudern, hatte der wackere Mann auch hier diese selbe
...
im geeigneten Augenblick unbemerkt aufnehmen. Aber freilich haben solche
...
Ich fühlte so viel vereinter weiblicher Kraft gegenüber etwas wie eine
...
[^250]: [WS: *Überbrettler*: Berliner Kabarettkünstler Anfang 20.
    Jahrhundert, vergleiche [Überbrettl](https://de.wikipedia.org/wiki/Überbrettl)]{.footnote}

[^251]: [WS: *Hala*: vermutlich gemeint: König
    [Hāla](https://en.wikipedia.org/wiki/Hāla), regierte 20-24 n. Chr.]{.footnote}

[^252]: [WS: *Schnadahüpfl*: vergleiche
    [Schnaderhüpfl](https://de.wikipedia.org/wiki/Gstanzl#Schnaderhüpfel)]{.footnote}
...
[^254]: [WS: *Sregarasatakas*: gemeint wohl das *Srngara-sataka* von
    [Bhartrihari](https://de.wikipedia.org/wiki/Bhartrihari)]{.footnote}

[^255]: [WS: *rangieren*: vergleiche [Rangieren](https://de.wikipedia.org/wiki/Rangieren),
    hier arrangieren]{.footnote}

[^256]: [WS: *Backschisch*: vergleiche
    [Bakschisch](https://de.wikipedia.org/wiki/Bakschisch)]{.footnote}

[^257]: [WS: *Marwar*: wörtlich „Wüstenregion“, vergleiche
    [Marwar](https://de.wikipedia.org/wiki/Marwar). Die Wüste ist heute als
    [Thar](https://de.wikipedia.org/wiki/Thar) bekannt, liegt aber nur zum Teil in Marwar.]{.footnote}
...
[^260]: [WS: *Belagerung von Burfur durch General Locke*: vermutlich
    gemeint: [Belagerung von](https://en.wikipedia.org/wiki/Siege_of_Bharatpur_(1805)) [Bharatpur](https://de.wikipedia.org/wiki/Bharatpur_(Indien)) durch General [Gerard Lake](https://de.wikipedia.org/wiki/Gerard_Lake,_1._Viscount_Lake)]{.footnote}

[^261]: [WS: *Nitisataka*: gemeint ist das *Niti-sataka* von
    [Bhartrihari](https://de.wikipedia.org/wiki/Bhartrihari), Nr. 63, übersetzt von
    [Johannes Hertel](https://de.wikipedia.org/wiki/Johannes_Hertel_(Indologe))]{.footnote}
...
[^265]: [WS: *Adschmir, Alwar, Udeipur*: vergleiche
    ...
    [Udaipur](https://de.wikipedia.org/wiki/Udaipur)]{.footnote}
...
[^272]: [WS: *Tscharpen-Bettstellen*: vergleiche
    [Charpai](https://de.wikipedia.org/wiki/Charpai)]{.footnote}
