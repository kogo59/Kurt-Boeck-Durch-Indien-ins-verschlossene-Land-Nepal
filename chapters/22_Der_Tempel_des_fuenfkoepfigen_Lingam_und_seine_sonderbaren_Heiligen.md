# 22. Kapitel. <br /><strong>Der Tempel des fünfköpfigen Lingam und seine sonderbaren Heiligen.</strong><br /><br /> {#Kapitel_zweiundzwanzig .unnumbered}
...
Voraussichtlich wird in absehbarer Zeit kein Europäer in die Lage
...
Gerade hier in Nepal, wo die strenggläubigen Hindus ganz unter sich zu
...
Je höher die Sonne stieg, um so schwächer wurde der Verkehr vor dem
...
Offenbar erweckte das Interesse, das ich an allen Einzelheiten der
...
Zu der Fähigkeit, das Atembedürfnis lange Zeit unterdrücken zu können,
...
[^574]: [WS: *Schinto-Feuerpriester, Fidschi-Wundermänner*: vergleiche
    [Feuerlauf](https://de.wikipedia.org/wiki/Feuerlauf). Neben Indien ist diese Praxis
    traditionell aus Japan und Polynesien bekannt. Trotz entsprechender
    Selbstreinigungsrituale auch für Laien gibt es keine „Feuerpriester“
    im Shintoismus.]{.footnote}

[^575]: [WS: *Bhadra Kali*: vergleiche
    [Bhadrakali](https://en.wikipedia.org/wiki/Bhadrakali) (en)]{.footnote}

[^576]: [WS: *Schundra Bela*: vermutlich *Chundra Lela*, welche erst als
    Christin Ruhe fand und entsprechend stark im frühen 20. Jahrhundert
    von Missionaren rezipiert wurde]{.footnote}

[^577]: [WS: *Bußrituale der Witwe*: das Hitzeritual wird *Panchatapa*
    genannt, das stehen im Wasser ist auch beim
    [Chhath](https://en.wikipedia.org/wiki/Chhath)-Fest üblich (en).]{.footnote}

[^578]: [WS: *Pranpuri*: möglicherweise der Wander-Sannyasi Praun Poori im
    18. Jahrhundert (?)]{.footnote}

[^579]: [WS: *Pahr*: vergleiche [Pahar](https://en.wikipedia.org/wiki/Pahar) (en)]{.footnote}

[^580]: [WS: *Om Scham Bam Lam Ram Yam Ham*: vergleiche
    [Bīja](https://en.wikipedia.org/wiki/Bīja) (en), verkürzte Meditationssilben zur
    Konzentration auf die [Chakras](https://de.wikipedia.org/wiki/Chakra); es existieren
    unterschiedliche Schulen, die verschiedene Silben/Abfolgen verwenden]{.footnote}

[^581]: [WS: *stundenlanges Atemanhalten*: vergleiche
    [Kumbhaka](https://en.wikipedia.org/wiki/Kumbhaka); hier liegt entweder ein
    kulturelles Missverständnis oder heute tatsächlich widerlegter
    Wunderglaube vor]{.footnote}
...
[^585]: [WS: *Amerikaner Bancroft*: eventuell Frederick Bancroft,
    Zauberkünstler im ausgehenden 19. Jahrhundert (?)]{.footnote}

[^586]: [WS: *Hauptmann Seymour*: Seymour desertierte und brach zweimal
    aus Anstalten in England aus, um in Indien wieder gefasst zu werden.
    Er war mit N. C. Paul bekannt; auch Blawatzky berichtete über ihn in
    *From The Caves And Jungles Of The Hindostan*.]{.footnote}
