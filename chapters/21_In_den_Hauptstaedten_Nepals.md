...
Der dem Palast zunächst stehende Tempel erhebt sich auf einem Sockel aus
...
Leider entbehren die neueren, unter den Gorkhas entstandenen
...
Hilfe gewährt, so wären für sie jetzt zweifellos Tibet wie Nepal offene
...
Zwischen diesem Platz und der Stadt liegt der Palast eines früheren
...
entrannen nur diejenigen, die zufällig in der Lage waren,
...
Die vorhin erwähnte Denkmalssäule steht in Bhatgaon neben einem
...
benutzte, ebenfalls von mir selbst in Form eines vollkommen
...
[^537]: [WS: *Bodhmandal- und Kathisambu-Tempel*: waren zwei
    ...
    *Lagan Tole* und nach dem Bericht von Lt. Col. George Hart Desmond
    ...
    „ruinösem Zustand“.]{.footnote}

[^538]: [WS: *Mehenkal*: *Mahankali* ist ein Avatar von sowohl
    Mahandeva-Shiva wie Kali, siehe auch Anmerkung zu Kal Bhairav. Nach
    Gimlette war dieser Tempel klein und sehr alt.]{.footnote}

[^539]: [WS: im Bild links der
    [Krishna-Tempel](https://commons.wikimedia.org/wiki/Category:Krishna_Temple_(Chyasim_Deval),_Patan).]{.footnote}
...
[^542]: [WS: *Deo Talli-Tempel*: vergleiche
    [Degutale-Tempel](https://commons.wikimedia.org/wiki/Category:Degutale_Temple,_Patan)]{.footnote}

[^543]: [WS: *Tope, Garb*: Tope meint [Stupa](https://de.wikipedia.org/wiki/Stupa),
    Garb(a) meint wohl vedisch *dhātu-garbha* (vgl. auch Dagoba) und
    wäre dann synonym zu Tope]{.footnote}
...
[^547]: [WS: *Nankaupaß*: vergleiche [Juyongguan](https://de.wikipedia.org/wiki/Juyongguan), zu dem auch *Nankou*
    (südliche Öffnung) gehört]{.footnote}
...
[^550]: [WS: *Harh Singh im sechzehnten Jahrhundert*: vergleiche
    [Harisimhadeva](https://en.wikipedia.org/wiki/Harisimhadeva) (en; Hari Simha,
    Hari Singh Deva, frühes 14. Jahrhundert); ab dem 15. Jahrhundert
    regierte die prosperierende
    [Malla-Dynastie](https://en.wikipedia.org/wiki/Malla_(Nepal)) (en)
    deren direkte Abstammung von Hari Simha fragwürdig ist. Weitere Malla-Herrscher in
    den drei Hauptstädten trugen ebenfalls Namen (wie Narasimha), die
    für eine Verballhornung in Frage kämen.]{.footnote}
